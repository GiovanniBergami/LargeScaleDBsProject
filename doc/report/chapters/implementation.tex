...
{../../src/libCommon/src/main/java/londonSafeTravel/dbms/graph/ManagePoint.java}

\section{Way: Create}
To insert a Way in the graph database the following code is used:
\lstinputlisting[linerange={35-76}, language=Java]
{../../src/libCommon/src/main/java/londonSafeTravel/dbms/graph/ManageWay.java}
...
{../../src/libCommon/src/main/java/londonSafeTravel/dbms/graph/ManageDisruption.java}
